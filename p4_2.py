...
# Menghitung panjang list
    ...
    def search(self, data):
        # Membuat pointer baru menunjuk ke node yang ditinjuk
        current = self.head
        found = False
        # Perulangan mencari node yang di cari
    ...
    def mainmenu(self):
       ...
       while (pilih == "y"):
           ...
           if(pilihan=="1"):
               os.system("clear")
               obj = str (input("Masukan data yang lain ingin anda tambahkan: "))
               self.insert(obj)
           elif(pilihan=="2"):
               os.system("clear")
               ...
               os.system("clear")
               print("Panjang dari queue adalah: "+str(self.sixe()))
               x = input("")
           elif(pilihan=="5"):
                os.system("clear")
                self.showData()
